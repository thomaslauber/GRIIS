...
var griis = gaul_1.filter(ee.Filter.and(ee.Filter.eq('ADM0_NAME','United States of America'),ee.Filter.neq('ADM1_NAME','Alaska'),ee.Filter.neq('ADM1_NAME','Hawaii'))).map(addVariablesWrapper('US_C', 'GRIIS', 0))
          ...
          .merge(gadm_0.filter(ee.Filter.eq('NAME_0','Reunion')).map(addVariablesWrapper('RE', 'GRIIS', 0)))
...
var pa_griis = ee.FeatureCollection([
  ...
  ee.Feature(gadm_1.filter(ee.Filter.eq('NAME_1','Little Cayman')).first()).set('griisCountryCode','KY-LC').set('checklist','GRIIS').set('level',1).select(['griisCountryCode','checklist','level']),
  ee.Feature(gadm_1.filter(ee.Filter.eq('NAME_1','Cayman Brac')).first()).set('griisCountryCode','KY-CB').set('checklist','GRIIS').set('level',1).select(['griisCountryCode','checklist','level']),
  ...
  ee.Feature(gadm_0.filter(ee.Filter.eq('NAME_0','Marshall Islands')).geometry().intersection(ee.Geometry.Polygon([[[166.5840694999883, 11.558043164322928],[166.5840694999883, 11.094833050540856],[167.1169064140508, 11.094833050540856],[167.1169064140508, 11.558043164322928]]], null, false), 30)).set('griisCountryCode','MH-RON').set('checklist','GRIIS').set('level',1).select(['griisCountryCode','checklist','level']),
  ee.Feature(gadm_0.filter(ee.Filter.eq('NAME_0','Marshall Islands')).geometry().intersection(ee.Geometry.Polygon([[[165.80786479355422, 10.251862877109255],[165.80786479355422, 9.94089762865783],[166.15942729355422, 9.94089762865783],[166.15942729355422, 10.251862877109255]]], null, false), 30)).set('griisCountryCode','MH-WTH').set('checklist','GRIIS').set('level',1).select(['griisCountryCode','checklist','level']),
  ...
  ee.Feature(gadm_0.filter(ee.Filter.eq('NAME_0','Seychelles')).geometry().intersection(ee.Geometry.Polygon([[[55.81493087212884, -4.331439411099683],[55.81493087212884, -4.390319962225569],[55.862996057675716, -4.390319962225569],[55.862996057675716, -4.331439411099683]]], null, false), 30)).set('griisCountryCode','SC_LDI').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(gadm_0.filter(ee.Filter.eq('NAME_0','Seychelles')).geometry().intersection(ee.Geometry.Polygon([[[50.99768923678992, -10.073046852370709],[50.99768923678992, -10.281881680702242],[51.26479433932898, -10.281881680702242],[51.26479433932898, -10.073046852370709]]], null, false), 30)).set('griisCountryCode','SC_FQA').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(gadm_0.filter(ee.Filter.eq('NAME_0','Seychelles')).geometry().intersection(ee.Geometry.Polygon([[[47.4758194745532, -9.640436515404451],[47.4758194745532, -9.804894734199626],[47.708592301701636, -9.804894734199626],[47.708592301701636, -9.640436515404451]]], null, false), 30)).set('griisCountryCode','SC_CO').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ...
  ee.Feature(wdpa.filter(ee.Filter.or(ee.Filter.eq('NAME','Galápagos Islands'),ee.Filter.eq('NAME','Galápagos'))).union().first()).set('griisCountryCode','EC_GP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Kruger National Park')).first()).set('griisCountryCode','ZA_KNP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Garden Route National Park')).first()).set('griisCountryCode','ZA_GRNP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Table Mountain National Park')).union().first()).set('griisCountryCode','ZA_TMNP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Tankwa Karoo National Park')).union().first()).set('griisCountryCode','ZA_TKNP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.or(ee.Filter.eq('NAME','Masai Mara'), ee.Filter.eq('NAME','Serengeti National Park'))).union().first()).set('griisCountryCode','KE_TZ_SEMAES').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Golden Gate Highlands National Park')).union().first()).set('griisCountryCode','ZA_GGHNP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Lord Howe Island')).union().first()).set('griisCountryCode','AU_LHI').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.and(ee.Filter.eq('NAME','Wadden Sea'), ee.Filter.eq('DESIG','Ramsar Site, Wetland of International Importance'))).union().first()).set('griisCountryCode','NL_WS').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Addo-Elephant National Park')).union().first()).set('griisCountryCode','ZA_AENP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Socotra Archipelago')).union().first()).set('griisCountryCode','YE_SA').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Augrabies Falls National Park')).union().first()).set('griisCountryCode','ZA_AFNP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Agulhas National Park')).union().first()).set('griisCountryCode','ZA_ANP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Archipielago Juan Fernández')).union().first()).set('griisCountryCode','CL_AJF').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Rapa Nui')).union().first()).set('griisCountryCode','CL_RNNP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Mountain Zebra National Park')).union().first()).set('griisCountryCode','ZA_MZNP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Curieuse')).union().first()).set('griisCountryCode','SC_CRSR').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Bontebok National Park')).union().first()).set('griisCountryCode','ZA_BNP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Prince Edward Islands')).union().first()).set('griisCountryCode','ZA_PEI').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Huvalu Conservation Area')).union().first()).set('griisCountryCode','NU_HCA').set('checklist','GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Mare Aux Cochons')).union().first()).set('griisCountryCode','SC_MAC').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ...
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Morne Seychellois National Park')).union().first()).set('griisCountryCode','SC_MSNP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Mokala National Park')).union().first()).set('griisCountryCode','ZA_MONP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Mapungupwe National Park')).union().first()).set('griisCountryCode','ZA_MANP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Camdeboo National Park')).union().first()).set('griisCountryCode','ZA_CANP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Silhouette National Park')).union().first()).set('griisCountryCode','SC_SNP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','West Coast National Park')).union().first()).set('griisCountryCode','ZA_WCNP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Vallée de Mai Nature Reserve')).union().first()).set('griisCountryCode','SC_VDMNR').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Marakele National Park')).union().first()).set('griisCountryCode','ZA_MKNP').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
  ...
  ee.Feature(wdpa.filter(ee.Filter.eq('NAME','Lake Mburo')).union().first()).set('griisCountryCode','UG_LM').set('checklist','PA-GRIIS').set('level',2).select(['griisCountryCode','checklist','level']),
